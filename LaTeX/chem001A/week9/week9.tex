...
\section{Wenesday Lecture}
\subsection{Back to redox?}
\begin{itemize}
  \item We just need to identify redox reactions, and identify which atom is being oxidized
  \item IN the exam, we don't need to balance a redox reaction (takes forever to do so)
\end{itemize}

\subsection{Mole to mole conversion}
Something about balancing equations or something

\begin{itemize}
  \item To use a balanced chemical reaction
  \item 4 molecules $H_2$ $\times{} \frac{2 moles H_2O}{H_2}$
  \item 17.3 moles $H_2$
\end{itemize}

\begin{enumerate}
  \item Identify amount of starting material and product of interest
  \item Balanced
  \item Bro skipped this slide...
\end{enumerate}


\begin{itemize}
  \item 4 moles of HCl = 2 moles of $Cl_2$
  \item 4.3 moles of HCl $\times{} \frac{2 moles Cl_2}{4 moles HCl} $ =  2.2 moles $Cl_2$
  \item Moles $CH_3OH$ \rightarrow{} moles $O_2$

    2 moles of $CH_3OH$ = 3 moles of $O_2$
  \item 8.31 moles of $CH_3OH$ \times{} $\frac{}{}$ bro skipped slide
\end{itemize}

\subsection{Gram to gram conversion problem}
In practical labs, we don't actually measure everything in moles, we actually measure in grams.

Unit 5 stuff and just convert stuff.

Grams of $H_2O$ can from by fully reacion 4.0 grams of $O_2$

\begin{enumerate}
  \item Molar mass of $O_2$, and $H_2O$
  \item Map conversion of $O_2$ grams to $H_2O$ grams
  \item mole-to-mole conversion: 1 moles $O_2$ = 2 moles $H_2O$
  \item Combine everything together and figure out how many gram off $H_2O$
\end{enumerate}

\subsection{Limiting reactant}
\begin{itemize}
  \item Understanding that you can a yield, and there will be left over ingredients.
  \item We keep making the mixture until one gets used up. The limiting reactant means that if we had more,
    we can make more mixture.
  \item Excess ingredient (raegant) is what you have more than the limiting factor
  \item \textbf{limiting reactant:} available in the smallest stoichiometric quantity given the ratios and is completely consumed.
    Determines the amount of product made
  \item \textbf{Excess reactatn:} The excess reactant that you have extra of.
  \item \textbf{theoretical yield:} Yield if we use up all of our ingredients and what is expected to produce from calculations.
\end{itemize}

Determining theoretical yield
\begin{enumerate}
  \item convert grams to moles
  \item mole to mole conv to each reactant to moles of product
  \item Identify product that makes the least amount of product (limiting)
  \item Then determine amount of product formed (theoretical yield)
\end{enumerate}
